	...
	<div class="add-employee-form">
		<div class="form-input">
			...
			<label>Employee ID </label>
				...
				<label>Year of experience </label><input type="text" id="yoe" class="input" /><br><br>
				<label>Designation </label><input type="text" id="designation" class="input" />
		</div>
		...
		<div class="top">
			<div class="search-box">
				<div class="search">
					<input type="number" class="searchTerm"
						placeholder="Type any employee id ie; 1" id="search-item">
